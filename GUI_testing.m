...
for ii = 6%1:length(handles.object_list)    
...
best = 0;
scene_pgm = strcat('found_objects/',current_scene,'/',current_scene,'.pgm');
for jj = 6 % Object list index - 2 is Calculator
...
firstFlag = 1;
dont_draw_lines = 0;
for ii = 6%:length(handles.object_list)
...
scene_pgm = strcat('input_images/scenes/',current_scene,'.pgm');
image_pgm = best;
[match_loc1, match_loc2, match_results,des1,loc1,loc2] = new_match(scene_pgm,image_pgm,0,0,current_scene);
